 ...
 * 
 */
public class HubImplTMP extends HttpServlet implements Hub {
	...
	public HubImplTMP(BundleContext context) {
	...
	private boolean createReader(String rssUrl) {
		...
		// logger.log(LogService.LOG_ERROR, "Tracker not statred", e);
		// }
		// return false;
	...
	private class FactoryTracker implements ServiceTrackerCustomizer {
		...
		public Object addingService(ServiceReference reference) {
			...
			try {
				...
				logger.log(LogService.LOG_ERROR, "Can not create feed reader");
			}
